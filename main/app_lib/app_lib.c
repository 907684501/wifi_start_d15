...
void app_lvgl_test(void)
{
    ...
    lv_label_set_text(label, "Hello World abcd 1234 ABCD!@#$^&*");
    lv_obj_align(label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_text_font(label, &lv_font_montserrat_38, LV_STATE_DEFAULT);
...
void load_ttf_font(void)
{
    ...
    ttf_font = lv_tiny_ttf_create_file("/storage/font1.ttf", 24); // 字体大小为 28
